   if (numbers.length === 0){   if (numbers.length === 0){   if (numbers.length === 0){    if (numbers.length === 0){    if (numbers.length === 0){    if (numbers.length === 0){    if (numbers.length === 0){    if (numbers.length === 0){    if (numbers.length === 0){
